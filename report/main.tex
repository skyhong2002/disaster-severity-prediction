...
artifact reaches \textbf{0.7917} and crosses Baseline 3 (\textbf{0.8056}); we
...
public-chase artifact with public MAE \textbf{0.7917}, which crosses Baseline 3.
...
Team 3 & 0.7628 & 1 \\
Team 4 & 0.7817 & 2 \\
\textbf{Team 5 selected public-chase artifact} & \textbf{0.7917} & \textbf{3} \\
Team 20 & 0.7942 & 4 \\
Team 2 & 0.7955 & 5 \\
Team 1 & 0.8043 & 6 \\
Baseline 3 & 0.8056 & 7 \\
...
\path{submissions/baseline3_private_hedge_v2_cat35_lower_early_pair_horizon_0p25_0p375_0p55_0p75_1.csv}
(Kaggle ref \texttt{53038031}, SHA-12 \texttt{eae8c5b0dc6f}). It was selected
after public-feedback probing as a horizon-specific private-hedge frontier
artifact, so it should not be described as a new training algorithm. More
anchor-tilted submitted hedge alternatives are refs \texttt{53038040},
\texttt{53038036}, and \texttt{53038033}. The reportable method lineage remains the 35/35/30
