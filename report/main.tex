...
\hline
v0 (Leaky) & Two-Stage LGBM & 0.2198 & 0.8094 \\
v2 (Fix Leak) & LightGBM Direct & 0.6942 & 0.8299 \\
v1 (XGB) & XGBoost Direct & 0.7150 & 0.8400* \\
Final & LGBM + XGB Ensemble & N/A & \textbf{0.8232} \\
\hline
\end{tabular}
\end{table}
...
forecasting drought severity levels from meteorological data. We discovered and resolved two major pitfalls: \textbf{Time-Leakage} during validation splits, and \textbf{Train-Test Discrepancy} caused by score reconstruction. Our final architecture discards noisy historical score features in favor of pure meteorological Direct Forecasting, augmented with domain-specific Drought Indices. By ensembling LightGBM and XGBoost, we achieved a reliable Kaggle public MAE of 0.8232. Future work includes running formal hyperparameter tuning for XGBoost, extracting longer rolling features, and exploring sequence-based models like Temporal Fusion Transformer.
