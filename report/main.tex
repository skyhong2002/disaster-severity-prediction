...
artifact reaches \textbf{0.7922} and crosses Baseline 3 (\textbf{0.8056}); we
...
public-chase artifact with public MAE \textbf{0.7922}, which crosses Baseline 3.
...
Team 3 & 0.7628 & 1 \\
Team 4 & 0.7817 & 2 \\
\textbf{Team 5 selected public-chase artifact} & \textbf{0.7922} & \textbf{3} \\
Team 20 & 0.7942 & 4 \\
Team 2 & 0.7955 & 5 \\
Baseline 3 & 0.8056 & 6 \\
...
\path{submissions/baseline3_private_hedge_v1_cat35_public_early_full_late_anchor_horizon_0p3_0p4_0p55_0p75_1.csv}
(Kaggle ref \texttt{53003220}, SHA-12 \texttt{695c62a4eb28}). It was selected
...
anchor-tilted submitted hedge alternatives are refs \texttt{53003222} and
\texttt{53003227}. The reportable method lineage remains the 35/35/30
