...
legal Kaggle public leaderboard score recorded by the repository is
\textbf{0.8124}.
\end{abstract}
...
The current best legal public submission uses a convex blend with weights
...
approximately 40\% of the test data. The current best legal Team 5 public MAE
recorded in the repository is \textbf{0.8124}, achieved by adding CatBoost as a
third ensemble member while keeping the leaky diagnostic submissions excluded
from official claims. The corresponding submission file is
...
\textbf{Team 5 (LGB/XGB/CatBoost)} & \textbf{0.8124} & \textbf{1} \\
\textbf{Team 5 (LGB/XGB Anchor)} & \textbf{0.8232} & \textbf{3} \\
Team 4 & 0.8392 & 37 \\
Team 3 & 0.8534 & 15 \\
Baseline 2 & 0.8623 & 1 \\
...
best legal public submission. The mean forecast gradually decreases from week 1
